...
import { INCOME_TRACKS } from "./data";
import { IncomeTrack } from "./types";

export default function IncomeTracks() {
  return (
    <section style={{ animation: "fadeUp 0.7s ease-out 0.42s both" }}>
      ...
      <div className="rounded-[2rem] bg-[#0a0520] border border-white/5 overflow-hidden card-glow">
        <div className="divide-y divide-white/[0.04]">
          {INCOME_TRACKS.map((track: IncomeTrack, i) => (
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mono text-[9px] uppercase tracking-[2px] text-white/30 mt-1">
                      {track.subtitle}
                    </p>
                  </div>
                </div>
