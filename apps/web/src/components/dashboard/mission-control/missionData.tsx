...
export const QUICK_ACTIONS: QuickAction[] = [
  {
    ...
    desc: "Resume your most active course.",
    icon: <Play size={18} />,
    color: "from-violet-600 to-fuchsia-600",
    href: "/courses/fullstack-systems",
  },
  {
    title: "Browse Courses",
    desc: "Explore your learning catalog.",
  ...
  },
  {
    ...
    desc: "Start a guided execution mission.",
    icon: <Briefcase size={18} />,
    color: "from-emerald-600 to-teal-600",
    href: "/courses/copywriting-framework",
  },
  {
    title: "Talk to AI Mentor",
    desc: "Get next-step strategic recommendations.",
    icon: <Brain size={18} />,
    color: "from-orange-600 to-rose-600",
    href: "/courses/llm-architecture",
  },
];
...
export const DAILY_MISSIONS: Mission[] = [
  {
    title: "Finish 1 lesson in Fullstack System Architecture",
    xp: "+150 XP",
    done: true,
    icon: <CheckCircle2 size={16} />,
  },
  {
    title: "Watch 20 mins of LLM Architecture module",
    xp: "+120 XP",
    done: false,
    icon: <Activity size={16} />,
  },
  {
    title: "Research one monetizable skill niche",
    xp: "+180 XP",
    done: false,
    icon: <Compass size={16} />,
  },
  {
    title: "Publish one proof-of-work update",
    xp: "+220 XP",
    done: false,
...
export const RECENT_ACTIVITY: ActivityItem[] = [
  ...
  {
    title: "Unlocked: LLM Architecture",
    time: "Yesterday",
